...
namespace Epic.Enums.Extensions
{
    public static partial class EnumExtensions
    {
        ...
        static bool IsFlags<T>() where T : struct, IEnumConstraint
        {
            return EnumInternal<T>.IsFlags;
        }

        static Type Type<T>() where T : struct, IEnumConstraint
        {
            return EnumInternal<T>.Type;
        }

        static Type UnderlyingType<T>() where T : struct, IEnumConstraint
        {
...
*/
        ...
        /// <summary>
        /// add exists value or remove not exists value
        /// </summary>
